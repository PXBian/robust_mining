...
namespace PrioritySearchTree {
  class InPlacePST {
    ...
    void exploreDown(int indexP, coord_t ymax, vector<PSTPoint>* points);
  ...
  public:
    ...
    vector<PSTPoint>* enumerate3SidedUp(coord_t xmin, coord_t xmax, coord_t ymin);
    vector<PSTPoint>* enumerate3SidedDown(coord_t xmin, coord_t xmax, coord_t ymax);
    void printTree();
  };
}
